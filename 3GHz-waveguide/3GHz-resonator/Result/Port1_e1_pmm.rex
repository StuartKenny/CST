...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="2.3500000000000000888">
      <FieldResultFile filename="Port1_e1[2.35].prt" meshname="Port1_e1_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
  ...
  <PlotSettings Clipping="Always on" Plot="1" ignore_symmetry="0" deformation="0">
    <Plane normal="-0 1 0" distance="25.27854919434"/>
  </PlotSettings>
  <Source type="SOLVER"/>
  <Units>
