...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:V^1.:m^-1" fieldname="Port1 e6" fieldtype="E-Field" frequency="0"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="2.2000000000000001776">
      <FieldResultFile filename="Port1_e6[2.2].prt" meshname="Port1_e6_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
