...
lifetime=s:surviveparchange
result=s:1
treepath=s:1D Results\Optimizer\Algorithm Statistics\Goal Sensitivities\0_S-Parameters_S1,1_ant_l
files=s:Algorithm Statistics\Goal Sensitivities\0_S-Parameters_S1,1_ant_l
xlabel=s:Trust Region Framework Iteration
...
lifetime=s:surviveparchange
result=s:1
treepath=s:1D Results\Optimizer\Algorithm Statistics\Goal Sensitivities\0_S-Parameters_S1,1_ant_wall_l
files=s:Algorithm Statistics\Goal Sensitivities\0_S-Parameters_S1,1_ant_wall_l
xlabel=s:Trust Region Framework Iteration
title=s:Algorithm Statistics\Goal Sensitivities
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\H-Field\h-field @ mid-point [1]
files=s:h-field @ mid-point_1,1_m3d.rex
files=s:h-field @ mid-point_1,1_m3d.rex
ylabel=s:h-field @ mid-point [1]
