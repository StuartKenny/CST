...
<MetaResultFile creator="Solver HFTD - Field 3DFD Monitor" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0">
      <FieldResultFile filename="h-field @ mid-point_1,1.m3d" type="m3d"/>
    </Frame>
  </ResultGroups>
  <ResultDataType complex="1" timedomain="0" vector="1"/>
  <SimulationDomain min="-3 -50.59999847412 -22.04999923706" max="325.1891479492 50.59999847412 25.04999923706"/>
  <PlotSettings Clipping="Possible" Plot="4" ignore_symmetry="0" deformation="0"/>
  <SubVolume min_pos="162.5945739746 -47.59999847412 -19.54999923706" max_pos="162.5945739746 47.59999847412 19.54999923706" min_index="91" max_index="40114" is_cropped="0" sub_folder=""/>
  <Source type="SOLVER"/>
</MetaResultFile>
