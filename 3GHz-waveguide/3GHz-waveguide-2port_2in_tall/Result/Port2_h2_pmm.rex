...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="2.25">
      <FieldResultFile filename="Port2_h2[2.25].prt" meshname="Port2_h2_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
  ...
  <PlotSettings Clipping="Always on" Plot="1" ignore_symmetry="0" deformation="0">
    <Plane normal="-0 1 0" distance="28.39999961853"/>
  </PlotSettings>
  <Source type="SOLVER"/>
  <Units>
