...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10.5">
      <FieldResultFile filename="Port1_e1[10.5].prt" meshname="Port1_e1_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
  ...
  <PlotSettings Clipping="Always on" Plot="1" ignore_symmetry="0" deformation="0">
    <Plane normal="0 1 0" distance="14.15999984741"/>
  </PlotSettings>
  <Source type="SOLVER"/>
  <Units>
