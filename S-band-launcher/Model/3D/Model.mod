...
'# frequency = GHz
'# time = ns
'# frequency range: fmin = 3 fmax = 3.1
...
With Cylinder 
     ...
     .Component "PEC" 
     .Material "PEC" 
     .OuterRadius "1.4*3.45" 
     .InnerRadius "0" 
     .Axis "z" 
     .Zrange "20-2.1*3.45", "20" 
     .Xcenter "0" 
     .Ycenter "0" 
     .Segments "0" 
     .Create 
...
With Brick
     ...
     .Component "Vacuum" 
     .Material "Vacuum" 
     .Xrange "-95.2/2", "95.2/2" 
     .Yrange "2*dcoaxBorder+dcoaxstub1+dstub1Stub2-500", "2*dcoaxBorder+dcoaxstub1+dstub1Stub2" 
     .Zrange "0", "38.1" 
     .Create
End With


'@ boolean insert shapes: Vacuum:solid2, Coax:coax

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:solid2", "Coax:coax" 


'@ delete shape: Vacuum:solid1

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Delete "Vacuum:solid1" 



'@ boolean insert shapes: Coax:coax, PEC:solid3

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Coax:coax", "PEC:solid3" 

'@ delete shape: Coax:coax

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Delete "Coax:coax" 


'@ delete shape: PEC:solid3

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Delete "PEC:solid3" 
...
With Cylinder 
     ...
     .Zrange "36", "50" 
     .Xcenter "0" 
     .Ycenter "dcoaxBorder+dcoaxstub1+dstub1Stub2" 
     .Segments "0" 
     .Create 
End With 
...
'@ rename block: PEC:solid3 to: PEC:conductor

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Rename "PEC:solid3", "conductor"


'@ rename block: PEC:solid4 to: PEC:puck

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Rename "PEC:solid4", "puck"


'@ rename block: Vacuum:solid2 to: Vacuum:vacuum

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Rename "Vacuum:solid2", "vacuum"


'@ boolean insert shapes: Vacuum:vacuum, PEC:stub1

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:vacuum", "PEC:stub1" 

'@ boolean insert shapes: Vacuum:vacuum, PEC:stub2

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:vacuum", "PEC:stub2" 

'@ boolean insert shapes: Vacuum:vacuum, PEC:conductor

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:vacuum", "PEC:conductor" 

'@ boolean insert shapes: Vacuum:vacuum, PEC:puck

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:vacuum", "PEC:puck" 

'@ boolean insert shapes: Vacuum:vacuum, Coax:coax

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Vacuum:vacuum", "Coax:coax" 
...
'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Pick.PickFaceFromId "Coax:coax", "6" 
...
With Port 
     ...
     .Xrange "45.5425", "49.6575" 
     .Yrange "151.94", "151.94" 
     .Zrange "11.3725", "15.4875" 
     .XrangeAdd "0.0", "0.0" 
     .YrangeAdd "0.0", "0.0" 
     .ZrangeAdd "0.0", "0.0" 
     .SingleEnded "False" 
...
'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Pick.PickFaceFromId "Vacuum:vacuum", "24" 
...
With Port 
     ...
     .ClipPickedPortToBound "False" 
     .Xrange "0", "95.2" 
     .Yrange "101.94", "140.04" 
     .Zrange "500.19925", "500.19925" 
     .XrangeAdd "0.0", "0.0" 
     .YrangeAdd "0.0", "0.0" 
     .ZrangeAdd "0.0", "0.0" 
     .SingleEnded "False" 
