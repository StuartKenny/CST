...
'@ rename block: Waveguide:walls to: Waveguide:outer_walls

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Rename "Waveguide:walls", "outer_walls"


'@ define extrude: Waveguide:draft_left_side

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
With Extrude 
     .Reset 
     .Name "draft_left_side" 
     .Component "Waveguide" 
     .Material "Aluminum" 
     .Mode "Pointlist" 
     .Height "wg_l" 
     .Twist "0.0" 
     .Taper "0.0" 
     .Origin "-wg_l/2", "0.0", "0.0" 
     .Uvector "0.0", "1.0", "0.0" 
     .Vvector "0.0", "0.0", "1.0" 
     .Point "-wg_h/2", "-wg_w/2" 
     .LineTo "-wg_h/2", "-wg_w/2+draft" 
     .LineTo "wg_h/2", "-wg_w/2" 
     .Create 
End With 
...
'@ delete shape: Waveguide:draft_left_side

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Delete "Waveguide:draft_left_side" 
...
'@ define extrude: Waveguide:draft_right_side

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
With Extrude 
     .Reset 
     .Name "draft_right_side" 
     .Component "Waveguide" 
     .Material "Aluminum" 
     .Mode "Pointlist" 
     .Height "wg_l" 
...
'@ define extrude: Waveguide:solid1
...
'@ rename block: Waveguide:solid1 to: Waveguide:draft_zero

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Rename "Waveguide:solid1", "draft_zero"


'@ define extrude: Waveguide:draft_wg_l
...
With Extrude 
     ...
     .Point "wg_l", "wg_h/2" 
     .LineTo "wg_l", "-wg_h/2" 
     .LineTo "wg_l-draft", "-wg_h/2" 
     .Create 
End With 


'@ change material: Waveguide:draft_wg_l to: Aluminum

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.ChangeMaterial "Waveguide:draft_wg_l", "Aluminum" 


'@ change material: Waveguide:draft_zero to: Aluminum

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.ChangeMaterial "Waveguide:draft_zero", "Aluminum" 
...
'@ boolean insert shapes: Waveguide:vacuum, Waveguide:draft_left_side

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Waveguide:vacuum", "Waveguide:draft_left_side" 

'@ boolean insert shapes: Waveguide:vacuum, Waveguide:draft_right_side

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Waveguide:vacuum", "Waveguide:draft_right_side" 

'@ boolean insert shapes: Waveguide:vacuum, Waveguide:draft_zero

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Waveguide:vacuum", "Waveguide:draft_zero" 

'@ boolean insert shapes: Waveguide:vacuum, Waveguide:draft_wg_l

'[VERSION]2019.7|28.0.2|20190705[/VERSION]
Solid.Insert "Waveguide:vacuum", "Waveguide:draft_wg_l" 
